...
<span class="container_wrap sub_container_wrap">
	<span class="container sub_container sub_container1">
		<span class="input_tab_wrap find_input_tab_wrap">
			<span class="input_tab id_input_tab " id="findUser">아이디찾기</span>
			<span class="input_tab pw_input_tab input_tab_on" id="findPassword">비밀번호찾기</span>
		</span>

        <span class="input_con">
            <span class="input_con">
                <span class="input_name">이메일주소</span>
...
<span class="input_btn_wrap">
	<span class="input_btn check_input_btn find_pw_input_btn">비밀번호찾기</span>
</span>
...
<span class="popup send_popup_email_null">
	<span class="popup_text">이메일을 입력해주세요.</span>
	<span class="popup_btn_wrap full_popup_btn_wrap">
		<span class="popup_btn popup_on close_popup_btn">확인</span>
	</span>
</span>
...
<span class="popup check_popup3">
	<span class="popup_text">인증이 완료되었습니다.
	비밀번호를 재설정해주세요.</span>
	<span class="popup_btn_wrap full_popup_btn_wrap">
		<span class="popup_btn popup_on new_pw_popup_btn" id="resetPassword">확인</span>
	</span>
</span>
...
$(document).ready(function() {
    ...
    $('.find_pw_input_btn').click(function() {
        ...
        // 인증번호 검증 요청
        $.post('{{ route('verifyCodeAndReturnPassReset') }}', {
    ...
    $('#resetPassword').click(function() {
        $(this).closest('.popup').hide(); // 해당 팝업 닫기
        location.href = '{{ route('resetPassword') }}';
    });
