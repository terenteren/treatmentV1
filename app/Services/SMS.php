...
class SMS {
    ...
    {
        // 환경 변수를 가져와서 초기화
        $this->socket_host = Config::get('services.icode.socket_host');
        $this->socket_port = Config::get('services.icode.socket_port');
        $this->icode_key = Config::get('services.icode.key');
    }

    public function SMS_con($host, $port, $key)
    {
